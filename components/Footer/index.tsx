    ...
    <footer className="pt-20 pb-10 bg-[#f2f7f7] px-5 4xl:px-10">
      <div className="container flex flex-col 7xl:flex-row gap-10">
        <div className="flex flex-col gap-30 7xl:max-w-[530px]">
          ...
          {/* Khung extensions TO 20% (h-14 → h-17, w-10 → w-12, padding tăng) */}
          <div className="flex flex-col flex-wrap content-start items-start gap-2.5 w-full max-w-[325px] h-min p-0 overflow-visible font-ibm-plex-mono font-semibold text-sm 4xl:grid 4xl:grid-rows-2 4xl:grid-cols-2 4xl:grid-auto-rows-[minmax(0,1fr)] 4xl:justify-center 4xl:gap-2.5 4xl:w-full 4xl:max-w-[610px] 4xl:h-min 4xl:p-0 4xl:relative 4xl:overflow-hidden">
            <Link
              href="https://chromewebstore.google.com/detail/mnloefcpaepkpmhaoipjkpikbnkmbnic?utm_source=item-share-cb"
              className="flex flex-row items-center gap-2.5 text-sm bg-white rounded-lg justify-start box-border h-17 w-full self-start relative overflow-hidden pl-[26px] pr-10 py-1 [box-shadow:rgba(0,0,0,0.12)_0px_1px_1px_0px] hover:shadow-md transition-all duration-200 4xl:will-change-transform"
              target="_blank"
              rel="noreferrer"
            >
              ...
              <span className="text-primary font-bold">{t("extensions.chrome")}</span>
            </Link>
            <Link
            ...
            >
              ...
              <span className="text-[#ff4929] font-bold">{t("extensions.windows")}</span>
            </Link>
            <Link
            ...
            >
              ...
              {t("extensions.downloadFor")}{" "}
              <span className="text-[#ff4929] font-bold">{t("extensions.ios")}</span>
            </Link>{" "}
            <Link
            ...
            >
              ...
              {t("extensions.downloadFor")}{" "}
              <span className="text-[#29b4ff] font-bold">{t("extensions.android")}</span>
            </Link>
          </div>
        </div>
